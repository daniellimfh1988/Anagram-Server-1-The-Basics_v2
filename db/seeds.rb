# #helmi's file - simpler but takes 30 minutes
# File.open("words").each do |word|
#   Word.create(dictionary_word: word.chomp!)
# end



#Jay's file - cray hard but 20 seconds
# Loop every word input
sql_query = "INSERT INTO words (dictionary_word, sorted_name, created_at, updated_at) VALUES "
n = 0
d = 0
